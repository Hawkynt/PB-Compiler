...
public sealed class BackendCallRoutingTests {
  ...
  public void Select_GivenNearIndirectCall_ThenStagesTargetInBxAndEmitsFfSlash2() {
    ...
    PowerBasic.Compiler.Backend.Targets.X86HostedTargetEmitter.EmitFunction(asm, selected, allocation!, [6, 4], 4);
  ...
  public void Select_GivenNearIndirectRegisterCall_ThenKeepsTargetOutsideArgumentPrefix(
    ...
    PowerBasic.Compiler.Backend.Targets.X86HostedTargetEmitter.EmitFunction(asm, selected, allocation!, parameterOffsets, parameters.Count * 2);
