...
public sealed class BackendCoverageTests {
  ...
  public void Selector_GivenTheBattery_ThenReportsWhatBlocksCoverage() {
    ...
    Assert.That(census.Selected, Is.GreaterThanOrEqualTo(147),
    ...
    Assert.That(census.Allocated, Is.GreaterThanOrEqualTo(117),
    ...
    Assert.That(census.MainBodies, Is.GreaterThanOrEqualTo(45),
