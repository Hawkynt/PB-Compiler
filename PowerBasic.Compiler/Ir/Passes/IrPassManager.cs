...
public sealed class IrPassManager {
  ...
  /// </list>
  /// <para>
  /// Everything else in <see cref="Standard"/> is optimization and is off: early array zero-fill
  /// elision, data-layout rewrites, unrolling, sccp, correlate, pointer checks, integer/float range
