...
public sealed class IrPassManager {
  ...
  /// speculative overflow versioning, unrolling, sccp, correlate, pointer checks, integer/float range
  /// folds, overflow coalescing, sroa, aggregate-sroa, mem2reg2, reassociate, polynomial recovery,
  ...
  public static IrPassManager Standard(bool optimizeForSpeed = false, bool includeModulePasses = true,
    ...
    // and only then the overflow versioner/unroller. Every one declines escaped/opaque storage rather
    // than speculating aliasing.
