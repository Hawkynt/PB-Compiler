...
| | now |
|---|---|
| every program compiles through the IR | 135 / 162 lower; **45 / 135** module bodies fully owned; 117 / 224 functions routed |
| observable behaviour identical | **0 disagreements** over 98 compilations |
