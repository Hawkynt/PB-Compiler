...
| | now |
|---|---|
| every program compiles through the IR | 135 / 162 lower; **47 / 135** module bodies fully owned; 119 / 224 functions routed |
| observable behaviour identical | **0 disagreements** over 102 compilations |
