...
- Grow the reusable fact domains beyond range/known-bits/nullness/alignment: dynamic type sets, pointer bases and object identity are still missing. Continue moving guard assumptions into those shared domains rather than transform-private maps.
