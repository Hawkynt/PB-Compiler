...
| [~] | Metastatements and their effect on the produced executable | 4 / 5 | 1 not reflected in the image: optimize.speed: '$OPTIMIZE SPEED' and '$OPTIMIZE SIZE' produce the SAME image, so the directive changed nothing - it should change the optimizer's objective, which changes which transformations it takes |
