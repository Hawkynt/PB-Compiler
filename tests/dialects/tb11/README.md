...
|---|---|---|---|
| [x] | Statement syntax and parameter combinations | 252 / 252 | all 252 accepted |
| [x] | Lowers to the IR | 175 / 252 | 175 of 252 reach the IR; the rest decline by name, which is the documented subset |
...
| [x] | Syntax belonging to another dialect is rejected | 50 / 50 | all 50 cleanly refused |
